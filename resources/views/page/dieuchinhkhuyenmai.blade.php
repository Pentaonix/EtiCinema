							...
							<table class="table">
								...
								@foreach($khuyenmai as $khuyenmai)
									<tr class="active">
										...
										<td hidden>{{$khuyenmai->id}}</td>
										<td hidden>{{$khuyenmai->giamgia}}</td>
						...
						<script type="text/javascript">
							...
							function modify() {
								...
								if (x < 1) {
									...
									$("#id").attr("value",$("#bangKm tr.duyduy1 td:eq(5)").text());
									$("#mgiamgia").attr("value",$("#bangKm tr.duyduy1 td:eq(6)").text());
								}
							}
						...
						<div style="display: none" id="addKm">
							...
							<form action="{{route('themKhuyenmai')}}" method="post" id="kmform">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="number" name="giamgia" id="giamgia" min="0.1" max="0.5" step="0.1"><br>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12 text-center">
									...
									<input type="button" class="btn btn-template-outlined" name="cancel" onclick="cancelAdd()" value="Hủy bỏ">
								</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input name="mtenkm" id="mtenkm" type="text" class="form-control">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label for="mbatdau">Ngày bắt đầu</label><br>
											<input type="date" name="mbatdau" id="mbatdau" class="form-control">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input name="mketthuc" id="mketthuc" type="date" class="form-control">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" id="mmota" name="mmota" class="form-control">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label for="mhinhanh">Hình ảnh minh họa</label><br>
											<input type="url" name="mhinhanh" id="mhinhanh"><br>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label for="mgiamgia">Giảm giá</label> <br>
											<input type="number" name="mgiamgia" id="mgiamgia" min="0.1" max="0.5" step="0.1"><br>
										</div>
									</div>
								</div>
