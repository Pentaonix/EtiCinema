                    ...
                    <div id="accordion" role="tablist">
                            ...
                            <div id="collapseOne" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" class="collapse ">
                                <div class="card-body">
                                    <p>Khi truy cập vào trang web này bạn chấp thuận và đồng ý với việc có thể gặp một số rủi
                                        ro và đồng ý rằng HHQ Cinema cũng như các bên liên kết chịu trách nhiệm xây dựng trang
                        ...
                        <div class="card card-primary">
                            ...
                            <div id="collapseTwo" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion" class="collapse">
                                <div class="card-body">Các thành viên tham gia HHQ Cinema sẽ bị Ngưng cấp quyền sử dụng dịch vụ (xoá nội dung, lock
                                    ...
                                    <ul>
                                        ...
                                        <li>Spam dưới mọi hình thức tại trang web HHQ Cinema.</li>
                                        <li>Vi phạm các quy định khác của HHQ Cinema</li>
                                        <p>HHQ Cinema sẽ không chịu trách nhiệm hay có nghĩa vụ gì đối với các nội dung đó, và
                        ...
                        <div class="card card-primary">
                            ...
                            <div id="collapseThree" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion" class="collapse">
                                <div class="card-body">Các thông tin trong trang web này được cung cấp “như đã đăng tải” và không kèm theo bất kỳ
                                    cam kết nào. Ban quản trị HHQ Cinema không bảo đảm hay khẳng định sự đúng đắn, tính chính
                                    xác, độ tin cậy hay bất cứ chuẩn mực nào trong việc sử dụng dữ liệu hay kết qủa của việc
                                    sử dụng dữ liệu trên trang web này. Mặc dù HHQ Cinema luôn cố gắng đảm bảo rằng tất cả
                                    ...
                                    một trong các chức năng sau của HHQ Cinema, cần ý thức rằng những hành động của mình cần
